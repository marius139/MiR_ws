...
(cl:defmethod cl:initialize-instance :after ((m <Encoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sdc21x0-msg:<Encoders> is deprecated: use sdc21x0-msg:Encoders instead.")))

(cl:ensure-generic-function 'time_delta-val :lambda-list '(m))
(cl:defmethod time_delta-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdc21x0-msg:time_delta-val is deprecated.  Use sdc21x0-msg:time_delta instead.")
  (time_delta m))

(cl:ensure-generic-function 'left_wheel-val :lambda-list '(m))
(cl:defmethod left_wheel-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdc21x0-msg:left_wheel-val is deprecated.  Use sdc21x0-msg:left_wheel instead.")
  (left_wheel m))

(cl:ensure-generic-function 'right_wheel-val :lambda-list '(m))
(cl:defmethod right_wheel-val ((m <Encoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdc21x0-msg:right_wheel-val is deprecated.  Use sdc21x0-msg:right_wheel instead.")
  (right_wheel m))
