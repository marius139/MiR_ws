...
(cl:defmethod cl:initialize-instance :after ((m <Twist2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mir_msgs-msg:<Twist2D> is deprecated: use mir_msgs-msg:Twist2D instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <Twist2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:linear-val is deprecated.  Use mir_msgs-msg:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <Twist2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:angular-val is deprecated.  Use mir_msgs-msg:angular instead.")
  (angular m))
