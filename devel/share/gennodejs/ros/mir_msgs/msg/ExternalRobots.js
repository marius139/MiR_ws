...
class ExternalRobots {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.robots.forEach((val) => {
      bufferOffset = ExternalRobot.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExternalRobots(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.robots[i] = ExternalRobot.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.robots.forEach((val) => {
      length += ExternalRobot.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExternalRobots(null);
    ...
    if (msg.robots !== undefined) {
      ...
      for (let i = 0; i < resolved.robots.length; ++i) {
        resolved.robots[i] = ExternalRobot.Resolve(msg.robots[i]);
      }
    }
    else {
      resolved.robots = []
