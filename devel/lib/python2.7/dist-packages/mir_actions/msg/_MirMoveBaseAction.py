...
class MirMoveBaseAction(genpy.Message):
  _md5sum = "88aa1864f69098a6ee37baaf8142c203"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_fB3I().pack(_x.action_goal.goal.max_plan_time, _x.action_goal.goal.clear_costmaps, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.max_plan_time, _x.action_goal.goal.clear_costmaps, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_fB3I().unpack(str[start:end])
