...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        goButton->setStyleSheet(QString::fromUtf8("background-color: rgb(207,20, 43);\n"
"color: rgb(0, 0, 0);"));
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        goButton->setText(QApplication::translate("MainWindowDesign", "Start transport", 0, QApplication::UnicodeUTF8));
