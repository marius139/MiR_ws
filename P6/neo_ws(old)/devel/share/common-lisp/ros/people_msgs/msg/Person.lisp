...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name people_msgs-msg:<Person> is deprecated: use people_msgs-msg:Person instead.")))
...
(cl:defmethod position-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader people_msgs-msg:position-val is deprecated.  Use people_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader people_msgs-msg:velocity-val is deprecated.  Use people_msgs-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'reliability-val :lambda-list '(m))
(cl:defmethod reliability-val ((m <Person>))
...
(cl:defmethod tagnames-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader people_msgs-msg:tagnames-val is deprecated.  Use people_msgs-msg:tagnames instead.")
  (tagnames m))

(cl:ensure-generic-function 'tags-val :lambda-list '(m))
(cl:defmethod tags-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader people_msgs-msg:tags-val is deprecated.  Use people_msgs-msg:tags instead.")
  (tags m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "0b7c0818b76476f3863bd13f4d59f8df")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "0b7c0818b76476f3863bd13f4d59f8df")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "string              name~%geometry_msgs/Point position~%geometry_msgs/Point velocity~%float64             reliability~%string[]            tagnames~%string[]            tags~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "string              name~%geometry_msgs/Point position~%geometry_msgs/Point velocity~%float64             reliability~%string[]            tagnames~%string[]            tags~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
