...
(cl:defmethod cl:initialize-instance :after ((m <PowerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name neo_msgs-msg:<PowerState> is deprecated: use neo_msgs-msg:PowerState instead.")))
...
(cl:defmethod power_consumption-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neo_msgs-msg:power_consumption-val is deprecated.  Use neo_msgs-msg:power_consumption instead.")
  (power_consumption m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neo_msgs-msg:time_remaining-val is deprecated.  Use neo_msgs-msg:time_remaining instead.")
  (time_remaining m))

(cl:ensure-generic-function 'prediction_method-val :lambda-list '(m))
(cl:defmethod prediction_method-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neo_msgs-msg:prediction_method-val is deprecated.  Use neo_msgs-msg:prediction_method instead.")
  (prediction_method m))

(cl:ensure-generic-function 'relative_capacity-val :lambda-list '(m))
(cl:defmethod relative_capacity-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neo_msgs-msg:relative_capacity-val is deprecated.  Use neo_msgs-msg:relative_capacity instead.")
  (relative_capacity m))

(cl:ensure-generic-function 'AC_present-val :lambda-list '(m))
(cl:defmethod AC_present-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader neo_msgs-msg:AC_present-val is deprecated.  Use neo_msgs-msg:AC_present instead.")
  (AC_present m))
